...
class UsersStatisticTabWidget extends StatefulWidget {
  final GameStatisticsDTO firstTabStatistics;
  final GameStatisticsDTO secondTabStatistics;
  final GameStatisticsDTO thirdTabStatistics;
  UsersStatisticTabWidget({super.key, required dynamic generalGameStatistics})
      : firstTabStatistics = generalGameStatistics.generalGameData,
        secondTabStatistics = generalGameStatistics.classicDeathMatch,
        thirdTabStatistics = generalGameStatistics.limitedTimeDeathMatch;

  @override
  _UsersStatisticTabWidgetState createState() => _UsersStatisticTabWidgetState();
}

class _UsersStatisticTabWidgetState extends State<UsersStatisticTabWidget> {
  @override
