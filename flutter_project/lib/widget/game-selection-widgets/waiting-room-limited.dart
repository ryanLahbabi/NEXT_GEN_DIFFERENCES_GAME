...
class WaitingScreenLimitedTime extends StatefulWidget {
  String? cardId, gameId;
  dynamic info;

  WaitingScreenLimitedTime(this.cardId, this.gameId, this.info);

  @override
  _WaitingScreenLimitedTimeState createState() =>
      _WaitingScreenLimitedTimeState();
}

class _WaitingScreenLimitedTimeState extends State<WaitingScreenLimitedTime> {
  final TextEditingController _timeController =
      TextEditingController(text: '30');
  final TextEditingController _addedTimeController =
  ...
  void initState() {
    ...
    setState(() {
      ...
      //GameService().limitedTimeSingleplayer(info);
    });
    ...
    _addedTimeController.addListener(() {
      int value = int.tryParse(_addedTimeController.text) ?? 1;
      if (value < 1) {
        _addedTimeController.text = '1';
      } else if (value > 30) {
        _addedTimeController.text = '30';
      }
    });
  }
              ...
              Checkbox(
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      print("sending access type for friendsOffriends");
                    });
                  }),
            ],
          ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildCustomTextField(
                        appLocalizations.translate('TIME_GAINED') ?? '',
                        _addedTimeController),
                  ],
                ),
              ),
              Expanded(
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => TimeLimitedWidget()));
                /*GameDataService()
                    .playerNames
                    .remove(AuthService.instance.username);*/
              ...
              child: Ink.image(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    final addedTime = _addedTimeController.text;
                    CommunicationSocket().send("start_game", {
                      "gameId": widget.gameId,
                      "totalTime": totalTime,
                      "addedTime": addedTime, //not in classic
